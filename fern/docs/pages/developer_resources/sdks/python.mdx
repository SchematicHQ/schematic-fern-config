---
title: Python
description: Use schematic-python to easily implement pricing and packaging in your python app with Schematic.
...
## Exception Handling
All errors thrown by the SDK will be subclasses of [`ApiError`](https://github.com/SchematicHQ/schematic-python/blob/main/src/schematic/core/api_error.py).
