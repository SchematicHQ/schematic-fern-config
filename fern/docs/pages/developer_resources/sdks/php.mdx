---
title: PHP
description: Install the schematic-php composer package, initialize a client with a secret key, and call the REST resources.
...
Initialize a client with an [API key secret](/quickstart/account-setup#2-create-your-api-keys).
