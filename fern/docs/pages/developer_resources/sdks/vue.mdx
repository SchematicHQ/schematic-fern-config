---
title: Vue
description: Use schematic-vue to quickly identify users, track events, and check flags client-side in your vue app with Schematic.
slug: developer_resources/sdks/vue
---
