...
description: A Python image search app that uses Schematic to meter usage, check feature access, and manage the subscription lifecycle.
slug: developer_resources/sample_apps/sample_python
---
...
<img
src="../../../assets/images/sample_python_billy.png"
/>
...
- Generate Schematic API keys in your account here (to fill in SCHEMATIC_API_KEY): https://docs.schematichq.com/developer_resources/environments
...
<img
src="../../../assets/images/sample_python_screenshot.png"
/>
...
- [How to implement metered features with Schematic](https://github.com/SchematicHQ/billy-python/blob/e03d3bb35b87925eb4151842894b784585330d77/main.py#L96)
- [Sending usage events to Schematic](/quickstart/instrument-your-app#4-send-usage-events)
- [Evaluating company entitlements with Schematic](/quickstart/instrument-your-app#3-check-an-entitlement)