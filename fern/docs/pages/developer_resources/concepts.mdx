...
Plans and Add-ons are separate concepts in Schematic, and when you create a new product you can choose the product type. 

Companies can only have 1 Plan, but they can have any number of Add-ons with distinct entitlements.

There are a number of scenarios where you may want to support an Add On, and the two most common are:
1. You sell additional functionality or licenses that increase the value of your core plans (e.g. Zoom Workplace) 
2. Each of your products is sold separately (e.g. DataDog)
