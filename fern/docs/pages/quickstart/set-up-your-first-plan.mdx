...
This is the dashboard track. Everything here happens in the Schematic app, in your browser. You will not need a code editor, a terminal, or an engineer sitting next to you.

By the end you will have a plan that grants access to a feature, a second feature with a monthly usage allowance, and a customer-facing billing portal that your customers can use to upgrade themselves. Plan on about twenty minutes.
...
Your application does need to be connected to Schematic once, so it knows which company is signed in and can ask Schematic what that company is allowed to do. That connection is the other track, and it is a one-time job. Send an engineer to [Instrument your app](/quickstart/instrument-your-app).
...
- **[Usage-based billing](/billing/usage-based-billing)** — charge by consumption instead of by seat.
