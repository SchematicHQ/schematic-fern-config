...
1. Clone our [React/Next.js quickstart project](https://github.com/schematichq/schematic-quickstart) or our [Vue/Nuxt quickstart project](https://github.com/schematichq/schematic-quickstart-vue-nuxt). You'll need a Schematic account to get started, and the quickstart will walk you through the rest!
2. Explore a hosted version of the [quickstart app online](https://schematic-quickstart.vercel.app/entitlements).
