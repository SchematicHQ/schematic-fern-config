...
1. On the **Entitlements** tab, click the plan you want to entitle (or "Add plan entitlement"). For the quickstart, choose the "Demo Plan".

![Entitle a feature step 1](../../assets/images/quickstart/quickstart-entitle-feature-3.png)

2. In the **Monetization Settings** panel, make sure the feature is included in the plan (toggled **On** for a boolean feature), then click "Save changes".
