...
In the [online quickstart](https://schematic-quickstart.vercel.app/components), you can see a setup component. Let's quickly add one to our local [quickstart app](https://github.com/schematichq/schematic-quickstart)
...
1. Click "Create Component" in the top right.
2. Give your component a name, e.g. "Customer Portal".
3. Under **Choose template**, select "Customer Portal" for this example.
4. Click "Create".
...
To add our component to the quickstart app, we'll need to get its component id and then add it to our quickstart's `.env.local` file.
...
You just created a fully featured Customer Portal and checkout flow. This is the most commonly used Schematic component, but there are [many other ways to leverage components](/components/overview) in Schematic.
