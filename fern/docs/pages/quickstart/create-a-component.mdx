...
All of our SDKs support creating temporary access tokens. The value for `lookup` is just the keys you'd use to lookup the company (learn more [here](/developer_resources/key_management)). Below is a typescript example.
