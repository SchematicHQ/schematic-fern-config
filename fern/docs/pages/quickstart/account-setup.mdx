...
2. Click **Settings** (the gear icon) at the bottom of the left navigation.
...
<Info>The sample data is only for demonstration purposes. You can delete freely delete it when you've finished the quickstart.</Info>
