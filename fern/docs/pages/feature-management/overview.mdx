...
description: Follow how an entitlement check resolves plan entitlements, company overrides, and global rules before defaulting to off.
...
![Feature Management Overview](../../assets/images/feature-management/features-homepage.png)
