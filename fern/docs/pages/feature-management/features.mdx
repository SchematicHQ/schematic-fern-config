---
title: Features
description: Map your product's features to Schematic to entitlement them to plans and enforce pricing and packaging.
...
<img
src="../../assets/images/feature-management/features-policy.png"
/>
...
<img
src="../../assets/images/feature-management/features-flag-tab.png"
/>
...
<Info>You can choose between Boolean, Event-based, or Trait-based feature types. The feature type can't be changed after the feature is created. You don't need to be sending events or traits yet — see [defining features before you send data](/feature-management/feature-types#defining-features-before-you-send-data).</Info>
...
<Info>Event-based features can have no limit, some numerical limit that is static within a period, or a limit that is dynamic based on traits that exist at the company level. Read more [here](/playbooks/metering#entitlement-options).</Info>

![Entitle a feature](../../assets/images/quickstart/quickstart-features-entitlements.png)

<Info>You'll need to make sure to send usage events to Schematic to track feature utilization as it occurs. Read more [here](/playbooks/metering#setting-up-an-event-based-metered-feature).</Info>