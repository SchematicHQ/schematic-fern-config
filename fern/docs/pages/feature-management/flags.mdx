---
title: Flags
description: Toggle functionality with prioritized rules evaluated against stored company context rather than context passed at runtime.

slug: feature-management/flags
---
