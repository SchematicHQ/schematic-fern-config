...
description: Attach an event to a feature so track calls are attributed to it and surfaced on the feature's Usage tab.
...
![Feature Usage Tab](../../assets/images/features/features-usage-tab.png)
...
![Feature View Edit](../../assets/images/features/features-view-edit.png)

3. Scroll to the **Event** section and select or create an event.

![Feature Tracking Event](../../assets/images/features/features-tracking-event.png)
