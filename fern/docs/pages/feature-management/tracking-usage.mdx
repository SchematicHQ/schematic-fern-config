...
description: Attach a usage event to a feature so usage is attributed to it and shown on its Usage tab.

slug: feature-management/feature-analytics
---
...
![Feature Usage Tab](../../assets/images/feature-management/features-usage-tab.png)
...
![Feature View Edit](../../assets/images/feature-management/features-view-edit.png)

3. Scroll to the **Event** section and select or create an event.

![Feature Tracking Event](../../assets/images/feature-management/features-tracking-event.png)
