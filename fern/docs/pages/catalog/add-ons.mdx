...
<Warning>An add on can grant unlimited use of a feature, but not a fixed monthly allowance. It can grant unlimited AI searches, for example, but not 500 per month.</Warning>
