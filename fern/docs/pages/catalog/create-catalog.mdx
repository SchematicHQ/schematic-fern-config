...
Your catalog reflect the plans and add ons that you offer your customers, including the corresponding entitlements. Below, we'll walk through creating plans and add ons, mapping them to Stripe products, and assigning an entitlement to a plan.
