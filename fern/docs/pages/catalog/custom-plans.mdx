...
- To let a customer try the tier above theirs before they commit, use a [time-limited override](/feature-management/overrides#time-limited-overrides), which expires on its own if they don't upgrade.
