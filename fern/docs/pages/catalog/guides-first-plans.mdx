...
To start, open the Configuration tab of the plans section (Plans > Configuration). Configure each plan type according to their requirements, then add the "Pro" plan to the Live Plans list. Click "Save" in the top right of the screen to apply the changes.
