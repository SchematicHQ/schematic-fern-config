...
description: Create a custom plan from a company profile, finalize it to generate the invoice, and confirm activation.
...
- **On payment** activates the company on the plan once the invoice is paid, within the due window you set (for example, 30 days). Until then, the plan stays pending.
...
- [Custom Plans API](/developer_resources/custom-plans-api) for running this same flow programmatically
