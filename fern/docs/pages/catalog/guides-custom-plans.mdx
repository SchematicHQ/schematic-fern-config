...
Finalizing generates a custom plan invoice for the company. The activation strategy is **On payment**: the company becomes active on the plan once the invoice is paid, within the due window you set (for example, 30 days).

<Info>The company is not active on the custom plan until the invoice is paid. You can track the invoice status on the plan's **Billing** tab.</Info>
