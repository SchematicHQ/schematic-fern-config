...
A common pattern for standard pricing tables is to layout your pricing table where each plan includes the features of the previous plan, plus some additional features. It commonly looks like this:
