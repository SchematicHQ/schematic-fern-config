...
This can be configured in the pricing table component by enabling the `plans.showInclusionText` option. For more details, see the [Pricing Table documentation](/components/pricing-table#styling-options-for-the-pricing-table).
