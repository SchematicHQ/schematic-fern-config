...
<CardGroup cols={2}>
  ...
  <Card title="Claude Cowork" icon="fa-solid fa-table-list" href="#claude-cowork">
    See instructions
  </Card>
  <Card title="ChatGPT" icon="fa-solid fa-comment" href="#chatgpt">
    See instructions
  </Card>
  <Card title="Other assistants" icon="fa-solid fa-plug" href="#other-assistants">
    See instructions
  </Card>
</CardGroup>
...
- **[Spot churn and expansion with usage signals](/use-cases/usage-signals)** — read low and high usage against an entitlement as the churn or upsell signal it is.
- **[Stay ahead of renewals and expirations](/use-cases/renewals)** — catch expiring overrides, trials, and terms before the customer does.
...
- **[Automate with webhooks and AI](/use-cases/automation)** — move a sweep you run by hand onto webhooks so it runs without you.
- **[Concepts](/concepts)** — plain-language definitions of plans, features, entitlements, and companies, if a term in an answer is unfamiliar.
