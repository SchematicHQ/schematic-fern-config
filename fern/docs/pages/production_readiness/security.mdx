---
title: Security
description: Review Schematic's SOC 2 and GDPR posture, encryption, key scoping, application security testing, SSO, and incident response.
...
Report a vulnerability, send a security questionnaire, or raise a suspected incident at `security@schematichq.com`.

For privacy and data protection, including data subject requests, write to `privacy@schematichq.com`.
...
![Soc2 Logo](../../assets/images/production_readiness/security-soc2.png)
...
Schematic acts as a processor for the Customer Data described above; you remain the controller. The corresponding commitments are set out in the [Data Processing Addendum](https://schematichq.com/dpa), which is available to all customers and covers processing terms, security measures, and assistance with data subject requests.

For transfers out of the EEA, the DPA incorporates the European Commission's controller-to-processor Standard Contractual Clauses, with the UK Addendum for transfers governed by UK GDPR and the Swiss variations for transfers governed by the FADP.

Schematic has appointed Article 27 representatives in both jurisdictions:

| Jurisdiction | Representative |
| --- | --- |
| EU | Osano International Compliance Services Limited, 25 North Wall Quay, Dublin 1, D01 H104 |
| UK | Osano UK Compliance LTD, 42-46 Fountain Street, Belfast, Antrim BT1 5EF |

Send privacy notices and data subject requests to `privacy@schematichq.com`.

Schematic maintains a data inventory map, a completed Data Protection Impact Assessment, a documented pseudonymization procedure, and a sub-processor change notification process. GDPR controls are monitored continuously in Vanta alongside the SOC 2 program. Current status is published on the [Trust Center](https://trust.schematichq.com), and the underlying documents are available on request.

The third parties that process Customer Data on our behalf are listed at [Subprocessors](https://schematichq.com/subprocessors). Data deletion is governed by the Data Deletion Policy listed below.
...
![2 Factor Authorization](../../assets/images/production_readiness/security-2fa.png)
...
Please report security vulnerabilities or bugs to `security@schematichq.com`.
