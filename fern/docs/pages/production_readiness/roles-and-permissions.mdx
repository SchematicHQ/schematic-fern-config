...
description: Assign the Admin or Member role, then scope a member's permissions per account resource and per environment.
...
| Permission | Why |
|---|---|
| **Companies** | Assign existing plans to companies |
| **Overrides** | Create company-level overrides |
| **Plan & Billing** | Grant existing credits to companies |
