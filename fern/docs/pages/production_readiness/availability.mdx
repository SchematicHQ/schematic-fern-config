---
title: Availability
description: Compare built-in caching, the Replicator, SDK fallbacks, and a self-hosted cache as ways to keep flag checks serving.
...
Schematic targets 99.99% uptime.
