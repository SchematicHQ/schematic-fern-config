---
title: Build a slack webhook
description: Point a Schematic webhook endpoint at a Slack workflow so company created and deleted events post to a channel.
slug: playbooks/slack-webhook
---
