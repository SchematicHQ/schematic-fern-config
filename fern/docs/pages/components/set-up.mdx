...
description: Install the components library, issue temporary access tokens from your server, and render SchematicEmbed in React.
...
If you haven't already done so, start by installing the Schematic developer SDK of your choosing. Then, you can implement the token exchange for a specific company using its [keys](https://docs.schematichq.com/concepts#keys):
