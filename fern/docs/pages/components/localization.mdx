...
The locale also sets how the components format numbers, currency, and dates. With `locale="it-IT"`, a price renders as `700.000 JPY` and a date as `21 novembre 2026`. The currency itself still comes from the customer's plan price, and only its formatting follows the locale.
