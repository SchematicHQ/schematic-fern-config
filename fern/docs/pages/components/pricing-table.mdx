...
Below are the options that will control the functionality of the Pricing Table.
...
| numberOfColumns | Number of columns to display | 1 | Options: `1`, `2`, `3` |

## Styling Options for the Pricing Table 

These options will control the styling of the Pricing Table and it's various components
