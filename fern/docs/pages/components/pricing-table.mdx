---
title: Pricing Table
description: Embed a public pricing table and control its CTAs, period toggle, plan sections, and typography from code.
...
<Note>
`plans.showInclusionText` is a common option for pricing tables. See [Good, Better, Best Pricing](/catalog/configuration#good-better-best-pricing) for a better understanding of how this works.
</Note>
