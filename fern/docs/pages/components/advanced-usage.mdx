...
function Checkout() {
  ...
  const checkout = useCallback(async () => {
    ...
    initializeWithPlan("plan_abc123");
...
Schematic supports Stripe Tax (and other 3rd party tax providers). Components can be configured to collect tax information from the user (e.g. billing address) and generate the correct taxes at checkout. 
...
![Stripe Tax Configuration](../../assets/images/components/components-stripe-tax-configuration.png)
...
![Checkout data collection](../../assets/images/components/components-checkout-data-collection.png)

And finally, taxes will be presented on the final checkout step.

![Checkout tax collection](../../assets/images/components/components-checkout-tax.png)
