...
| Layout      | Notes                                                                                                                                            |
| ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| `portal`    | Renders the customer portal and default starting page for Schematic Components. If you want this, just load a component using the default setup. |
| `checkout`  | Renders the checkout flow; usage is documented above.                                                                                            |
