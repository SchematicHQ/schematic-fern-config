...
In addition to the checkout flow, you can also choose to load other parts of the Schematic Components library instead.To do this, you'll want to set a different value in `setLayout`. The accepted values are: 
