...
When determining if a checkout event is an upgrade or downgrade, the following logic is used. These steps represent upgrades, and downgrades are the inverse.
