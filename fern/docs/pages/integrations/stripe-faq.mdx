...
When adding a credit card via the the Stripe Dashboard, you'll also need to set it as the default payment method for Schematic to recognize this. (This is handled automatically when a customer checkouts through Schematic Components). 

![Set Default Paymethod Method in Stripe](../../assets/images/stripe/stripe-troubleshooting-set-default-card.png)
