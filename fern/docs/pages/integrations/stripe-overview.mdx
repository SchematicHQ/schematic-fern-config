...
This means companies do not need to exist in Stripe in order to check out — they just need to have a company record in Schematic. When they complete checkout for the first time, Schematic automatically provisions a Stripe customer and subscription for them.
