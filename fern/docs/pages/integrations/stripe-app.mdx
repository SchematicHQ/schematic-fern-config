---
title: Stripe App
description: Install the Schematic side panel inside Stripe to view a customer's plan and feature usage, and grant overrides.
...
4. Click **Connect**. No additional configuration is needed to establish the Stripe/Schematic connection.
