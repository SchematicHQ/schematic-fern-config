...
description: Add Schematic as a Segment destination so existing track and identify calls populate company profiles and metered features.
...
<img
  src="../../assets/images/segment_screencap.png"
/>
