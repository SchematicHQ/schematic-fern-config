...
description: Build a HubSpot workflow with a custom code action that upserts companies and traits into the Schematic API.
...
Navigate to Automations and select Workflows. In the Create Workflow dropdown select From scratch.
...
Name the secret SCH_SECRET, and, in another tab, [get your secret key from Schematic](/quickstart/account-setup#2-create-your-api-keys).
