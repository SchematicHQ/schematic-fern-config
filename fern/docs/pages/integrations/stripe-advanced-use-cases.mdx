---
title: Stripe Advanced Use Cases
description: Collect tax at checkout with Stripe Tax, covering jurisdiction registrations and the component settings that surface it.
...
This page covers advanced configurations for the Stripe integration. 
