---
title: Concepts
description: "Definitions of Schematic's core concepts, including features, flags, entitlements, plans, add ons, companies, keys, traits, and usage, plus how an entitlement check resolves at runtime."
slug: concepts
---

This page defines the core concepts in Schematic and shows how they fit together. The first half is a glossary. The second half covers how Schematic resolves an entitlement check, how data flows between your application, Schematic, and Stripe, and how to verify that your integration is working.
...
A **subscription** represents a company's current plan and add ons, typically synced from Stripe. When a Stripe subscription changes, Schematic updates the company's plan assignment automatically.
...
**Usage** is event-based or trait-based consumption tracked against a feature. It powers metered entitlements and usage-based billing, and it is the basis for enforcement, such as blocking access once a limit is reached.

Usage events arrive as `track` calls and are attributed to a company, a user, and a feature.
