...
On a metered entitlement you also pick how often the allowance resets: daily, weekly, or monthly. Daily and weekly allowances run from the day the company enrolled in the plan. For a monthly allowance you choose whether the month follows the company's billing period start date or the first of the calendar month, so a company that subscribes on March 15th can either get a month running March 15th to April 14th or reset with everyone else on April 1st. Credit grants carry their own separate cadences, covered in [Credit Lifecycle](/billing/credit-burndown#credit-lifecycle).
