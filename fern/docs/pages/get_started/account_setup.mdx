...
See [Stripe Integration](./stripe) for more information.
...
2. Leave the flag key as "mechnical-keyboards".
...
You've now created your first Entitlement of "Mechnical Keyboards" and added it to the "Developers" Plan.
