...
| --- | --- | --- |
| `1` to `99` | Cap the key at that percentage | Set the cap to that percentage |
| `0` | Leave the key uncapped | Remove the cap |
| Omitted or `null` | Leave the key uncapped | Leave the cap unchanged |
