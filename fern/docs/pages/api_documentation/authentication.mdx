...
description: Authenticate Schematic API requests with environment-scoped secret and publishable keys, and know which key belongs on the server and which can ship to the client.
