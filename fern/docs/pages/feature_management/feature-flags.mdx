...
For example, if a company is a part of a beta cohort, you can asynchronously update the profile in Schematic and that context will be used when the flag is evaluated. The full example is [here](/playbooks/rollout), and demonstrates how to check flags in your codebase.
...
All policy created at the Feature level is reflected in the corresponding flag. You can see how the associated flag and derived rules using the Flag tab within a Feature.
