...
Under credit-based pricing, cash is received before delivery. A customer who buys 10,000 credits has paid for consumption that has not happened yet, revenue is recognized as they consume, and credits they never consume are breakage recognized on a separate schedule. Applying that treatment requires a record of every grant, draw, and expiry with its price attached.

Schematic's credit ledger is that record. This page documents what it contains, where the boundary with Stripe and your accounting system sits, and how to read the data out.
