...
description: Pair Stripe for payments with Schematic for entitlements, and pick from pay as you go, overage, and credit models.
...
- **[Billing Entities](/billing/billing-entities)**: Let one company pay for another company's subscription while each keeps its own plan, entitlements, and usage data.
