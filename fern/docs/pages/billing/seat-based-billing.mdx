...
Billing for a seat and budgeting what that seat can spend are different problems. When seats and autonomous agents draw on a shared credit pool, see [Seat and Agent Budgets](/billing/seat-and-agent-budgets) for scaling a credit grant by license count and attributing draws to the actor that made them.
