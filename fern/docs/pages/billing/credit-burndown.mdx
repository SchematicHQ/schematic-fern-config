...
| Automatic or user-controlled top-ups | `auto_topup_availability`, `postpaid_enabled` | See [API fields](/billing/empty-credit-balances#api-fields) |
...
4. Choose "Automatic top-ups" or "User-controlled top-ups" for what happens when credits run out, covered in [Who controls auto top-up](#who-controls-auto-top-up) below.
