...
To zero out a specific credit grant (set its remaining balance to zero), use the [Zero Out Grant](/api-reference/billing-credits/zero-out-grant) endpoint. This is useful for administrative purposes when you need to reset or cancel a credit grant.
