...
- [Applying an override programmatically](/feature-management/overrides#applying-an-override-programatically) — use the `/company-overrides` endpoint from your admin layer or CRM.
