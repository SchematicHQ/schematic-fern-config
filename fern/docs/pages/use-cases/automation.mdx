...
- [MCP Server](/building-with-ai#model-context-protocol-mcp) — manage entitlement data from AI tools.
- [Automation recipes](/ai-automations) — put an agent on a schedule to sweep redundant flag checks, catch entitlement drift, and build an account review queue.
