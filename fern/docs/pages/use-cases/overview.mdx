...
Schematic is a usage-based billing engine for AI and software companies. It gives product, growth, and engineering teams one place to price what they sell, bill for what customers use, and enforce entitlements in real time, without hard-coding pricing and access into your application. Metering, credits, real-time limit enforcement, and custom plans are built in, and seat-based and hybrid plans work the same way.
...
- **[Meter on a real-time credit ledger](/use-cases/credit-ledger)** — drive enforcement and billing off an accurate ledger with reservations, not a stale snapshot.
- **[Simulate a pricing change](/use-cases/pricing-simulation)** — preview revenue and margin impact against real usage before shipping a reprice. Currently in closed beta.
...
- **[Meter on a real-time credit ledger](/use-cases/credit-ledger)** — the real-time ledger and reservations underneath credit and usage pricing.
