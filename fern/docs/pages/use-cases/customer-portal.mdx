...
![Plan Manager, Included Features, and Metered Features elements](../../assets/images/use-cases/component-builder.png)

The customer portal also supports self-service checkout to change plans, adjust entitlements like seat counts, and purchase additional credits. 
...
- [Build your own UI](/components/build-your-own/overview) — the hooks and derivations behind every component, for full control of the UI.
