...
- [Applying an override programmatically](/feature-management/overrides#applying-an-override-programmatically) — create the grant from your CRM or admin tooling.
