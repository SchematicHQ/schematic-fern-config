...
- [Pricing Table](/components/drop-in/pricing-table) — the public-facing plan and pricing component.
...
- [Drop-in components](/components/drop-in/overview) — the same components, imported and themed in code.
