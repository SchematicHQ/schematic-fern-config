...
- [Handling Empty Credit Balances](/billing/empty-credit-balances) — choose whether a company is blocked, topped up, or billed in arrears at zero.
...
- [Meter on a real-time credit ledger](/use-cases/credit-ledger) — the ledger, reservations, and exactly-once semantics underneath credits.
