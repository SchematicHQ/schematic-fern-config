...
Every plan a company has moved between, with the origin plan, the destination plan, and what caused the move. This is where the end of a trial shows up: a company that does not convert lands on the fallback plan, and a company that does converts up to the paid plan. Find it on the company profile.
...
- [React SDK](/developer_resources/sdks/react) — read trial status and end date to render a countdown in your app.
- [Managing Company Plans](/catalog/managing-company-plans) — assign the trial plan to a company and convert it afterward.
