// Custom docs footer. Replaces Fern's default footer (configured via `footer:`
// in docs.yml) so we can add a "Cookie Settings" link next to the social icons
// that opens Osano's consent drawer. Because this is a real Fern-compiled
// component (not an injected <script>), it renders in `fern docs dev` and on the
// deployed site, and React owns it — so it never disappears.

const socials = [
  {
    href: "https://github.com/schematichq",
    label: "GitHub",
    viewBox: "0 0 512 512",
  ...
  {
    href: "https://www.linkedin.com/company/96648350/",
    label: "LinkedIn",
    viewBox: "0 0 448 512",
...
export default function CustomFooter() {
  return (
    <footer className="fern-layout-footer not-prose">
      <div className="mx-auto flex w-full max-w-page-width flex-col items-center gap-4 px-page-padding py-8">
        <div className="flex items-center justify-center gap-4">
          {socials.map((s) => (
            ...
            >
              <svg width="16" height="16" viewBox={s.viewBox} fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path d={s.path} />
              </svg>
            </a>
          ))}
